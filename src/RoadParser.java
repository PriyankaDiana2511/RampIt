...
public class RoadParser {
	...
	public static Segment parseTrace(String file) throws IOException{
		String traceString = contentsOfFile(file);
		char[][] trace2D = map2D(traceString);
		Segment trace  = generateTrace(trace2D);
	}
